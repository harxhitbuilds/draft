    ...
    <div className="space-y-8 px-4 py-8">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          <IconUserCheck />
          <h2>View Owner Profiles</h2>
        </div>
        <p className="text-muted-foreground text-xs">
          When an idea interests you, visit the owner's profile to find their
          social links and reach out. Profiles show contact links and published
          ideas for context.
        </p>
      </div>
    </div>
